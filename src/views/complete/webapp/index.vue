        ...
        >
          <div class="home-form-row">
            <div class="home-form-col">
              <el-row>
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-user"></i></el-col>
                <el-col :span="span_input">
                  <el-form-item prop="Ename">
                    <el-input v-model="eForm.Ename" :placeholder="$t('RegInfo.Ename')" clearable></el-input>
                  </el-form-item>                      
                </el-col>
                <el-col :span="1" class="paddingleft"><span class="redstart">*</span></el-col>
              </el-row>
              <el-row v-if="config.Eemail && config.Eemail.E">
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-message"></i></el-col>
                <el-col :span="span_input">
              ...
              <el-row v-if="config.Ephone && config.Ephone.E">
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-mobile-phone"></i></el-col>
                <el-col :span="span_input">
              ...
              <el-row v-if="config.Edept && config.Edept.E">
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-house"></i></el-col>
                <el-col :span="span_input">
              ...
              <el-row v-if="config.Edivision && config.Edivision.E">
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-map-location"></i></el-col>
                <el-col :span="span_input">
              ...
              <div class="form-submit" align="center">
                  <el-button round type="primary" @click="onSubmit_E('eForm')" :loading="loading" class="fullWidth">{{ $t('submit') }}</el-button>                         
              </div>
            </div>
          </div>
        </el-form>
          ...
          <div class="home-form-row">
            <div class="home-form-col">
              ...
              <el-row v-if="config.Vunit && config.Vunit.E">
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-office-building"></i></el-col>
                <el-col :span="span_input">
              ...
              <el-row v-if="config.Vnation && config.Vnation.E">
                <el-col :span="span_icon" class="form-icon"><svg-icon class-name="international-icon" icon-class="icd-earth" /></el-col>
                <el-col :span="span_input">
              ...
              <el-row v-if="config.Vid && config.Vid.E">
                <el-col :span="span_icon" class="form-icon"><i class="el-icon-postcard"></i></el-col>
                <el-col :span="7">
              ...
              <el-row v-if="config.Vplate && config.Vplate.E">
                <el-col :span="span_icon" class="form-icon"> <svg-icon icon-class="drive"></svg-icon> </el-col>
                <el-col :span="span_input">
...
export default {
  ...
  methods: {
    ...
    async routerPush(){
      ...
      this.$router.push(this.ret_url?{'path':this.ret_url}:{'name':'add'})
      this.loading = false
    },
  }
}
